(function () {
    angular.module('app').controller('app.views.locations.index', [
        '$scope', '$timeout', 'uiGridConstants', '$uibModal', 'abp.services.app.location', 'abp.services.app.room', 'abp.services.app.employee',
        function ($scope, $timeout, uiGridConstants, $uibModal, locationService, roomService, employeeService) {
            var vm = this;
            vm.loading = false;
            vm.rooms = [];
            vm.employees = [];
                ...
                columnDefs: [                  
                    ...
                    },                   
                    {
                        ...
                        cellTemplate:
                            ...
                            '<div class=\"ui-grid-cell-contents\"><span>{{row.entity.room.name}}</span></div>' +
                            '</div>'
                    },
                     {
            ...
            vm.exportToExcel = function () {
                vm.loading = true;              
                locationService.exportToExcel(vm.filters)
            ...
            vm.getLocations = function () {
                ...
                locationService.getLocations(vm.filters).then(function (result) {
