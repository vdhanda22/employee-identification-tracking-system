...
//            Utils.d(DEBUG_MY_PRESENCE, "ConversationListFragment.onMyPresenceChange" +
...
//            Utils.e(DEBUG_MY_PRESENCE, "ConversationListFragment.onMyPresenceChange" +
...
//    };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Utils.d(TAG, "ConversationListFragment.onCreateView");
...
//                getResources().getDrawable(R.drawable.decorator_fragment_conversation_list)));
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Utils.d(TAG, "ConversationListFragment.onViewCreated");

        conversationsHandler.upsertConversationsListener(this);
        Utils.d(TAG, "ConversationListFragment.onCreateView: conversationMessagesHandler attached");
        conversationsHandler.connect();

        myPresenceHandler.upsertPresenceListener(this);
        Utils.d(DEBUG_MY_PRESENCE, "ConversationListFragment.onCreateView: myPresenceHandler attached");
...
//                ChatManager.getInstance().getLoggedUser().getId(), onMyPresenceListener);
    ...
    public void onDestroy() {
        ...
        Utils.d(TAG, "ConversationListFragment.onDestroy: conversationMessagesHandler detached");

        myPresenceHandler.removePresenceListener(this);
        Utils.d(DEBUG_MY_PRESENCE, "ConversationListFragment.onDestroy: myPresenceHandler detached");
    ...
    private void setAddNewConversationClickBehaviour() {
        Utils.d(TAG, "ConversationListFragment.setAddNewConversationClickBehaviour");
    ...
    public void onConversationAdded(Conversation conversation, ChatRuntimeException e) {
        ...
        Utils.d(TAG, "ConversationListFragment.onConversationAdded");
    ...
    public void onConversationChanged(Conversation conversation, ChatRuntimeException e) {
        ...
        Utils.d(TAG, "ConversationListFragment.onConversationChanged");
    ...
    public void onConversationRemoved(ChatRuntimeException e) {
        Utils.d(TAG, "ConversationListFragment.onConversationRemoved");
        if (e == null) {
            conversationsListAdapter.notifyDataSetChanged();
            toggleNoConversationLayoutVisibility(conversationsListAdapter.getItemCount());
        } else {
            Utils.d(TAG, "ConversationListFragment.onConversationRemoved: " + e.toString());
        }
    }
    ...
    private void startMessageActivity(Conversation conversation) {
        Utils.d(TAG, "ConversationListFragment.startMessageActivity: conversation == " + conversation.toString());
    ...
    public void isLoggedUserOnline(boolean isConnected, String deviceId) {
        // TODO: 09/01/18
        Utils.d(DEBUG_MY_PRESENCE, "ConversationListFragment.isUserOnline: " +
    ...
    public void onMyPresenceError(Exception e) {
        // TODO: 09/01/18
        Utils.e(DEBUG_MY_PRESENCE, "ConversationListFragment.onMyPresenceError: " + e.toString());
    }

    @Override
    public void onSwipeMenuClosed(Conversation conversation, int position) {
//        Utils.i(TAG, "onSwipeMenuClosed: conversation: " + conversation.toString() + " position: " + position);
...
//        Utils.i(TAG, "onSwipeMenuUnread: conversation: " + conversation.toString() + " position: " + position);
    ...
    private void deleteConversation(final String conversationId, Map<String, String> headerParams) {
        Utils.d(TAG, "ConversationListFragment::deleteConversation");
        ...
        OnResponseRetrievedCallback<String> callback = new OnResponseRetrievedCallback<String>() {
            ...
            public void onSuccess(String response) {
                Utils.i(TAG, "ConversationListFragment::deleteConversation::" +
                        " conversation with uid " + conversationId + " deleted with success");
            }

            @Override
            public void onError(Exception e) {
                Utils.e(TAG, "ConversationListFragment::deleteConversation::" +
    ...
    private void closeSupportGroup(final String groupId, Map<String, String> headerParams) {
        Utils.d(TAG, "ConversationListFragment::closeSupportGroup");

        // callback called when the group is closed
        OnResponseRetrievedCallback<String> callback = new OnResponseRetrievedCallback<String>() {
            @Override
            public void onSuccess(String response) {
                Utils.i(TAG, "ConversationListFragment::closeSupportGroup::" +
                        " group with uid " + groupId + " closed with success");
            }

            @Override
            public void onError(Exception e) {
                Utils.e(TAG, "ConversationListFragment::closeSupportGroup::" +
