...
public class MyPresenceHandler {
    ...
    private DatabaseReference lastActivityRef;
    ...
    public MyPresenceHandler(String firebaseUrl, String appId, String userId) {
        ...
        if (StringUtils.isValid(firebaseUrl)) {
            lastActivityRef = database.getReferenceFromUrl(firebaseUrl)
                    .child("/apps/" + appId + "/presence/" + userId + "/lastActivity");
        } else {
            lastActivityRef = database.getReference()
                    .child("/apps/" + appId + "/presence/" + userId + "/lastActivity");
        }
    ...
    public void upsertPresenceListener(MyPresenceListener myPresenceListener) {
        if (myPresenceListeners.contains(myPresenceListener)) {
            ...
            Utils.i(DEBUG_MY_PRESENCE, "MyPresenceHandler.upsertPresenceListener: " +
    ...
    public ValueEventListener connect() {
        if (valueEventListener == null) {
            valueEventListener = connectedRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot snapshot) {
                    ...
                    if (connected) {
                        ...
                        lastActivityRef.setValue(ServerValue.TIMESTAMP);
                ...
                public void onCancelled(DatabaseError error) {
                    Utils.i(DEBUG_MY_PRESENCE, "MyPresenceHandler.connect.onCancelled: " +
            ...
            Utils.d(DEBUG_MY_PRESENCE, "MyPresenceHandler.connect: listener already added.");
        }
    ...
    public void dispose() {
        if (myPresenceListeners != null && myPresenceListeners.size() > 0) {
            ...
            Utils.d(DEBUG_MY_PRESENCE, "MyPresenceHandler.disconnect:" +
