...
public class ChatManager {
    ...
    public void setLoggedUser(IChatUser loggedUser) {
        ...
        Utils.d(TAG, "ChatManager.setloggedUser: loggedUser == " + loggedUser.toString());
        // serialize on disk
...
//        Log.v(TAG, "ChatManager.getloggedUser");
    ...
    public boolean isUserLogged() {
        Utils.d(TAG, "ChatManager.isUserLogged");
        boolean isUserLogged = getLoggedUser() != null ? true : false;
        Utils.d(TAG, "ChatManager.isUserLogged: isUserLogged == " + isUserLogged);
        return isUserLogged;
    }

    public String getAppId() {
        Utils.d(TAG, "getAppId");
    ...
    public void createContactFor(String uid,Map<String, Object> user,
                                 final OnContactCreatedCallback callback) {
        ...
        ChatAuthentication.getInstance().signInAnonymously(loginActivity,
                new ChatAuthentication.OnChatLoginCallback() {
                    ...
                    public void onChatLoginSuccess(IChatUser currentUser) {
                        ...
                        Utils.i(TAG, "chat has been initialized with success");
        ...
        ChatAuthentication.getInstance()
                .signInWithEmailAndPassword(loginActivity, email, password,
                        new ChatAuthentication.OnChatLoginCallback() {
                            ...
                            @Override
                            public void onChatLoginError(Exception e) {
                                Utils.e(TAG, "onChatLoginError", e);
                                onChatLoginCallback.onChatLoginError(e);
...
//        IOUtils.saveObjectToFile(context, _SERIALIZED_CHAT_CONFIGURATION_LOGGED_USER, currentUser);
    ...
    public void dispose() {
        ...
        for (Map.Entry<String, PresenceHandler> entry : presenceHandlerMap.entrySet()) {
            ...
            Utils.d(TAG, "presenceHandler for recipientId: " + recipientId + " disposed");
        }
        ...
        for (Map.Entry<String, ConversationMessagesHandler> entry : conversationMessagesHandlerMap.entrySet()) {
            ...
            Utils.d(TAG, "conversationMessagesHandler for recipientId: " + recipientId + " disposed");
        }
...
//        } catch (IOException e) {
//            Utils.e(DEBUG_LOGIN, "cannot delete instanceId. " + e.getMessage());
//            return;
//        }
//    }
    ...
    private void deleteInstanceId() {
        ...
        Utils.d(TAG_TOKEN, "ChatManager.deleteInstanceId: token ==  " + token);
...
//    }
    ...
    public ConversationMessagesHandler getConversationMessagesHandler(IChatUser recipient) {
        ...
        Utils.d(TAG, "Getting ConversationMessagesHandler for recipientId " + recipientId);

        if (conversationMessagesHandlerMap.containsKey(recipientId)) {
            Utils.i(TAG, "ConversationMessagesHandler for recipientId " + recipientId + " already inizialized. Return it");
            ...
            Utils.i(TAG, "ConversationMessagesHandler for recipientId " + recipientId + " created.");
    ...
    public PresenceHandler getPresenceHandler(String recipientId) {
        Utils.d(TAG, "Getting PresenceHandler for recipientId " + recipientId);

        if (presenceHandlerMap.containsKey(recipientId)) {
            Utils.i(TAG, "PresenceHandler for recipientId " + recipientId + " already inizialized. Return it");
            ...
            Utils.i(TAG, "PresenceHandler for recipientId " + recipientId + " created.");
...
//
//        Utils.d(TAG, "sending text message to recipientId : " + recipient_id + " with text : " + text + " and customAttributes : " + customAttributes);
//
...
//    }
    ...
    public void sendTextMessage(String recipientId, String recipientFullName, String text, String channelType,
        ...
        Utils.d(TAG, "sending text message to recipientId : " + recipientId +
    ...
    public void sendImageMessage(String recipientId, String recipientFullName, String text, String channelType,
        ...
        Utils.d(TAG, "sending image message to recipientId : " + recipientId +
                ", recipientFullName: " + recipientFullName + " with text : " +
                text + " and metadata : " + metadata);
...
//start configuration
    ...
    public static final class Configuration {
        ...
        public Configuration(Builder builder) {
            Utils.v(TAG, "Configuration constructor called");
        ...
        public static final class Builder {
            ...
            public Builder(String appId) {
                Utils.d(TAG, "Configuration.Builder: appId = " + appId);

                mAppId = appId;
            }

            public Builder firebaseUrl(String firebaseUrl) {
                Utils.d(TAG, "Configuration.Builder.firebaseUrl: firebaseUrl = " + firebaseUrl);
            ...
            public Builder storageBucket(String storageBucket) {
                Utils.d(TAG, "Configuration.Builder.storageReference: storageBucket = " + storageBucket);
            ...
            public Configuration build() {
                Utils.d(TAG, "Configuration.build");
