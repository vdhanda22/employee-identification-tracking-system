 ...
 */
public class RepairExteriorFragment extends Fragment implements View.OnClickListener ,SymbolStateListener {
    ...
    public static RepairExteriorFragment newInstance() {
        RepairExteriorFragment f = new RepairExteriorFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.vehicle_exterior_fragment, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if(vehicle!=null)
            AppUtils.loadVehicleExteriorMarks(vehicle, markerView, getActivity(), fixedMarksIds);
    }
    ...
    public void showSelectedMarkInfo()
    {
        ...
        if(selected!=null)
        {
            ...
            AlertDialogFragment alert=AlertDialogFragment.newInstance("",AppUtils.getLocalizeString(getActivity(),"","Please select a damage to add pictures or to view its detail"),AppUtils.getLocalizeString(getActivity(),"Ok","Ok"),false);
    ...
    public void removeSelectedMarker()
    {
        ...
        if (AppUtils.getSettings(getActivity()).isCanRemoveDamage())
        {
            ...
            alert=AlertDialogFragment.newInstance(AppUtils.getLocalizeString(getActivity(),"RemoveMark","Remove Mark"),AppUtils.getLocalizeString(getActivity(),"RemoveMarkError","This mark can not be removed"),AppUtils.getLocalizeString(getActivity(),"Ok","Ok"),false);
