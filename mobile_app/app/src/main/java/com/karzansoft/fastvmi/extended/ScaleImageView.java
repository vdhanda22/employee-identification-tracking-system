...
public class ScaleImageView extends ImageView implements View.OnTouchListener {
    ...
    public volatile boolean isReachedLeft, isReachedRight;
    ...
    private boolean isScalingDisable;

    public boolean isScare() {
        return isScare;
    }

    public void setScare(boolean isScare) {
    ...
    protected boolean setFrame(int l, int t, int r, int b) {
        ...
        mMinScale = mScale;
      //  Log.e("Scale",""+mScale+ " "+paddingWidth+" : "+paddingHeight+" "+mWidth+" "+mHeight);
//        zoomTo(mScale, mWidth / 2, mHeight / 2);
    ...
    public boolean isScalingDisable() {
        return isScalingDisable;
    }

    public void setScalingDisable(boolean isScalingDisable) {
        this.isScalingDisable = isScalingDisable;
    }
}
