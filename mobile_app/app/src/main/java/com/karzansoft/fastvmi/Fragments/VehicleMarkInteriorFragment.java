 ...
 */
public class VehicleMarkInteriorFragment extends BaseFragment implements View.OnClickListener ,SymbolStateListener {
    Button mNext;
    MarkerViewInterior markerView;
    ImageView imgLdent,imgInfo,imgDel,imgBrk,imgDelAll;
    ...
    public static VehicleMarkInteriorFragment newInstance(int current_mode,ValidateOperationResponse currentOpe,MovementInfo movementInfo) {
        VehicleMarkInteriorFragment f = new VehicleMarkInteriorFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            String jsonString=savedInstanceState.getString("IMARKS", "");
            Util.LogE("SavedInstanceState:Marksi",""+jsonString);
            try{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_vehicle_marks_interior, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if(symbolsHashMap.size()>0)
        {
            ...
            AppUtils.loadCheckoutInteriorMrks(currentOperation, markerView, getActivity(), fixedMarksIds);
        loadCustomImage();
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        try {
            ...
            if (symbolsHashMap != null) {
                ...
                Util.LogE("Fragment I", "" + jsonString);
                outState.putString("IMARKS", jsonString);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void fillData()
    {
        ...
        {
            if (currentMovement.getInMarks() != null)
                currentMovement.getInMarks().addAll(marks);
            else
                currentMovement.setInMarks(marks);
        }
        else
        {
            if (currentMovement.getOutMarks() != null)
                currentMovement.getOutMarks().addAll(marks);
            else
        ...
        switch(v.getId())
        {
            case R.id.vm_action_next:
                ...
                if (current_mode == Constant.REPLACEMENT_CHECKIN) {
                    AppUtils.saveMovementInfo(getActivity(),currentMovement);
                    ReplacementFragment fragment = ReplacementFragment.newInstance(Constant.REPLACEMENT_CHECKOUT);
                    ...
                    NotesFragment fragment = NotesFragment.newInstance(current_mode,currentOperation,currentMovement);
                    addFragment(fragment, fragment.getClass().getName());
                } else {
                    RANotesFragment fragment = RANotesFragment.newInstance(current_mode,currentMovement);
                    addFragment(fragment, fragment.getClass().getName());
                }
                break;
            ...
            case R.id.img_del:
                ...
                if (appSettings.isCanRemoveDamage())// Garage Movement
                     {
                    alert=AlertDialogFragment.newInstance(getlocalizeString("RemoveMark","Remove Mark"),getlocalizeString("RemoveMarkMsg","Are you sure you want to remove this mark?"),getlocalizeString("Remove","Remove"),true);
                    alert.setButtonsClickListener(new DialogInterface.OnClickListener() {
                        @Override
