...
function getlastindex(array) {
    //Get last index var lastindex = undefined;
    for (var i in array)
...
//$("example").onclick = function() {
    //Add onload event handler //addEvent(window, "load", aaaa);
...
function dump(arr,level) {
    var dumped_text = "";
    if(!level) level = 0;
    //The padding given at the beginning of the line. var level_padding = "";
    for(var j=0;
    j <level+1;
    j ++) level_padding += "    ";
...
{
    //Array/Hashes/Objects for(var item in arr)
...
{
    //If it is an array, dumped_text += level_padding + "'" + item + "' ...\n";
    ...
    //Stings/Chars/Numbers etc. dumped_text = "===>"+arr+"<===("+typeof(arr)+")";
}
